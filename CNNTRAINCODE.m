...
imds = imageDatastore('C:\Users\HP\Desktop\Khalid Code\Khalid updated Dataset\Class of final dataset','IncludeSubfolders',true,'LabelSource','foldernames');
...
for i=1:numel(imdsValidation.Files)
     ...
     a = imread(char(a));
    YPred(i,1) = classify(netTransfer,a);
    i
