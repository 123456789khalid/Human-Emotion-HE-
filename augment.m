rootFolder = fullfile('D:\Ph.DFull Data\Khalid updated Dataset\3. Augment with 30%\Augmented Dataset with 331 331 from 30%data\Waqar');
imgSets = imageSet(fullfile(rootFolder,'Waqar'));
ok = imgSets.Count
%%
